...
urlpatterns = [
    ...
    path('view_reported_labours_and_take_action/', views.view_reported_labours_and_take_action,
         name="view_reported_labours_and_take_action"),
    path('station_viewcomplaint_sendreplay/', views.station_viewcomplaint_sendreplay,
         name="station_viewcomplaint_sendreplay"),
    ...
    path('send_reply_to_complaint_stn/<int:complaint_id>/', views.send_reply_to_complaint_stn,
         name="send_reply_to_complaint_stn"),
    ...
    path('recognize_face/', views.recognize_face, name='recognize_face'),  # Add this line for facial recognition
]
